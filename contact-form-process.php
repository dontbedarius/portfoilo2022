...
if (isset($_POST['Email'])) {
    ...
    $email_to = "darius@dontbedarius.com";
    $email_subject = "New Message From Portfolio";

    function problem($error)
    {
        echo "Sorry, but there were error(s) found with the info you submitted. ";
    ...
    if (!preg_match($email_exp, $email)) {
        $error_message .= 'The email you entered is not valid.<br>';
    }
